...
// Второй тип, переводится к первому типу
...
void var::operator+=(const var a) {
	...
	//cout << "a.GetVarInt(): " << a.GetVarInt() << endl;
	...
	// Cправа double, cлева другой тип
	...
	// Cправа string, cлева другой тип
...
void var::operator-=(const var a) {
	...
	if (varIntActive && a.GetVarIntActive())
		...
		varDouble -= a.GetVarDouble();
	else if (varStringActive && a.GetVarStringActive()) {} // От string нельзя - string
	...
	else if (varStringActive && a.GetVarIntActive()) {} // От string нельзя - int
	// Cправа double, cлева другой тип
	else if (varIntActive && a.GetVarDoubleActive()) {
		varInt -= a.GetVarDouble();
	...
	else if (varStringActive && a.GetVarDoubleActive()) {} // От string нельзя - double
...
// Реализовать преобразование типов
var var::operator=(const var element) {
	// Проверка на акт. элементы
	/*
	if (varIntActive)
		cout << "varIntActive" << endl;
	if (varDoubleActive)
		cout << "varDoubleActive" << endl;
	if (varStringActive)
		cout << "varStringActive" << endl;
	...
	if (element.GetVarIntActive())
		cout << "element.GetVarIntActive()" << endl;
	if (element.GetVarDoubleActive())
		cout << "element.GetVarDoubleActive()" << endl;
	if (element.GetVarStringActive())
		cout << "element.GetVarStringActive()" << endl;

	cout << "element.GetVarInt(): " << element.GetVarInt() << endl;
	cout << "element.GetVarDouble(): " << element.GetVarDouble() << endl;
	cout << "element.GetVarString(): " << element.GetVarString() << endl;
	*/

	if (!element.GetVarIntActive() && !element.GetVarDoubleActive()) {
		// cout << "Отработка 1го" << endl;
...
var operator+(const var a, const var b) {
	...
	// Слева double, справа другой тип
	...
	// str + int
	// Слева string, справа другой тип
...
var operator*(const var a, const var b) {
	...
	cout << "Ошибка!" << endl;
	return 0; // Вернуть класс через конструктор
}
var operator/(const var a, const var b) {
	if (a.GetVarStringActive() && b.GetVarStringActive()) {
		char temp[200];
